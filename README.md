...
> [!NOTE]
> Данный репозиторий относится к части проекта [FFXIVJobGuideRU](https://github.com/Murakumo-JP/FFXIVJobGuideRU)
> 
> Служит для сбора информацый обновления умений с сайта JobGuide
